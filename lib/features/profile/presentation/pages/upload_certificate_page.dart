...
class _UploadCertificatePageState extends State<UploadCertificatePage> {
  ...
  Future<void> _pickFile() async {
    // Open the photo gallery and let the user pick an image of their certificate.
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            const ProfileTopBar(title: 'Upload certificate'),
            Expanded(
...
/// Empty state: dashed box prompting the user to pick a certificate.
...
/// Filled state: dashed box showing the uploaded certificate and a replace action.
